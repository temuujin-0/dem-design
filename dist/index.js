  ...
  "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    (function() {
      ...
      var React46 = require_react(), Internals = {
        ...
        p: 0,
        findDOMNode: null
      }, REACT_PORTAL_TYPE = Symbol.for("react.portal"), ReactSharedInternals = React46.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
...
function isReactElement(node) {
  return /* @__PURE__ */ (0, import_react4.isValidElement)(node) && !isFragment(node);
}
...
function useHeights(getKey2, onItemAdd, onItemRemove) {
  ...
  var promiseIdRef = (0, import_react7.useRef)(0);
  function cancelRaf() {
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var visibleRef = (0, import_react12.useRef)(null);
  useIsomorphicLayoutEffect_default(function() {
...
var TreeNode = function TreeNode2(props) {
  ...
  var context = import_react14.default.useContext(TreeContext);
  var unstableContext = import_react14.default.useContext(UnstableContext);
  var selectHandleRef = import_react14.default.useRef(null);
  var _React$useState = import_react14.default.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), dragNodeHighlight = _React$useState2[0], setDragNodeHighlight = _React$useState2[1];
  var isDisabled = import_react14.default.useMemo(function() {
  ...
  var isCheckable = import_react14.default.useMemo(function() {
  ...
  var isSelectable = import_react14.default.useMemo(function() {
  ...
  var isDraggable = import_react14.default.useMemo(function() {
  ...
  var hasChildren = import_react14.default.useMemo(function() {
    var _ref = getEntity(context.keyEntities, eventKey) || {}, children = _ref.children;
    return Boolean((children || []).length);
  }, [context.keyEntities, eventKey]);
  var memoizedIsLeaf = import_react14.default.useMemo(function() {
    if (isLeaf === false) {
      return false;
    }
  ...
  var dragHandlerNode = import_react14.default.useMemo(function() {
  ...
  var renderSwitcher = function renderSwitcher2() {
    if (memoizedIsLeaf) {
      ...
      return _switcherIconDom !== false ? /* @__PURE__ */ import_react14.default.createElement("span", {
    ...
    return switcherIconDom !== false ? /* @__PURE__ */ import_react14.default.createElement("span", {
      onClick: onExpand,
  ...
  var checkboxNode = import_react14.default.useMemo(function() {
    if (!isCheckable) {
      return null;
    }
  ...
  var nodeState = import_react14.default.useMemo(function() {
    if (memoizedIsLeaf) {
      return null;
    }
    return expanded ? ICON_OPEN : ICON_CLOSE;
  }, [memoizedIsLeaf, expanded]);
  var iconNode = import_react14.default.useMemo(function() {
    return /* @__PURE__ */ import_react14.default.createElement("span", {
  ...
  var dropIndicatorNode = import_react14.default.useMemo(function() {
  ...
  var selectorNode = import_react14.default.useMemo(function() {
    ...
    if (context.showIcon) {
      ...
      $icon = currentIcon ? /* @__PURE__ */ import_react14.default.createElement("span", {
    ...
    }, $icon, /* @__PURE__ */ import_react14.default.createElement("span", {
  ...
  return /* @__PURE__ */ import_react14.default.createElement("div", _extends({
    ref: domRef,
    role: "treeitem",
    ...
    onMouseMove
  }, ariaSelected, dataOrAriaAttributeProps), /* @__PURE__ */ import_react14.default.createElement(Indent_default, {
    prefixCls: context.prefixCls,
    level,
    isStart,
    isEnd
...
var Tree2 = ({
  ...
  const [expandedNodes, setExpandedNodes] = (0, import_react16.useState)([]);
  const [updateView, setUpdateView] = (0, import_react16.useState)(false);
  ...
  const unMountContextMenus = () => {
    ...
    if (wrapper) {
      import_react_dom3.default.unmountComponentAtNode(wrapper);
    }
  };
      ...
      if (!info.node?.disableContextMenu) {
        if (contextMenus && (contextMenus.length > 0 || Object.values(contextMenus).length > 0)) {
          ...
          if (menuItems && menuItems.length > 0) {
            const menuRenderViews = /* @__PURE__ */ import_react16.default.createElement(ClickAwayListener, { onClickAway: unMountContextMenus }, /* @__PURE__ */ import_react16.default.createElement(
              "div",
              {
              ...
              menuItems.map((menu) => {
                return /* @__PURE__ */ import_react16.default.createElement(
                  ...
                  /* @__PURE__ */ import_react16.default.createElement("i", { className: "m-nav__link-icon " + menu.iconClassName }),
                  /* @__PURE__ */ import_react16.default.createElement("span", { className: "m-nav__link-text" }, menu.text)
                );
              })
            ));
            ...
            import_react_dom3.default.render(menuRenderViews, container);
          }
        } else {
          return null;
        }
...
var DatePicker = ({ options, onSelect, defaultValue }) => {
  ...
  return /* @__PURE__ */ import_react17.default.createElement("select", { value: selectedValue, onChange: handleChange }, options.map((option, index2) => /* @__PURE__ */ import_react17.default.createElement("option", { key: index2, value: option.value }, option.label)));
};
